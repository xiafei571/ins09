...
public class SurveyServiceImpl implements SurveyService {
	...
	public Result<SurveyForm> getSurveyForm(Integer surveyId) {
		...
		/*
		 * SurveyOption s1 = new SurveyOption(surveyId, 1001, "計算理論"); SurveyOption s2 =
		 * new SurveyOption(surveyId, 1002, "プログラム理論"); SurveyOption s3 = new
		 * SurveyOption(surveyId, 1003, "数理論理学"); SurveyOption s4 = new
		 * SurveyOption(surveyId, 1004, "プログラム言語論"); SurveyOption s5 = new
		 * SurveyOption(surveyId, 1005, "ソフトウェア工学"); SurveyOption s6 = new
		 * SurveyOption(surveyId, 1006, "形式手法"); SurveyOption s7 = new
		 * SurveyOption(surveyId, 1007, "機械学習"); SurveyOption s8 = new
		 * SurveyOption(surveyId, 1008, "自然言語処理"); SurveyOption s9 = new
		 * SurveyOption(surveyId, 1009, "画像解析"); SurveyOption s10 = new
		 * SurveyOption(surveyId, 1010, "並列アーキテクチャ"); List<SurveyOption> options =
		 * Lists.newArrayList(s1,s2,s3,s4,s5,s6,s7,s8,s9,s10);
		 */

		a = getSurvey_OptionById(Id);
		List<SurveyOption> options = surveyMapper.getSurveyOptionList(a);
